...
<div class="container-fluid">
    ...
    <form class="col-lg-6" method="post" action="/input/dokter/{{ $dokter->slug }}">
        @method('put')
        @csrf
        <div class="card-body">
          ...
          <div class="form-group">
            ...
            <select class="form-control @error('gender_id') is-invalid @enderror" name="gender_id" id="gender_id">
              @foreach ($genders as $gender)
                @if (old('gender_id', $dokter->gender_id) == $gender->id)  
              ...
              <div class="input-group date" id="timepicker" data-target-input="nearest">
                <input  type="text" 
                        ...
                        data-target="#timepicker"
                         value="{{ old('jam_start', date('H:i A', strtotime($dokter->jam_start))) }}">
              ...
              <div class="input-group date" id="timepicker2" data-target-input="nearest">
                <input  type="text" 
                        ...
                        data-target="#timepicker2"
                         value="{{ old('jam_end', date('H:i A', strtotime($dokter->jam_end))) }}">
